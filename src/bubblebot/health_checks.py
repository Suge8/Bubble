"""
health_checks.py
Health and crash-loop protection for BubbleBot macOS overlay app.
"""
...
def get_log_dir():
    ...
    log_dir = Path.home() / "Library" / "Logs" / "bubblebot"
...
LOG_DIR = get_log_dir()
LOG_PATH = LOG_DIR / "bubblebot_error_log.txt"
CRASH_COUNTER_FILE = LOG_DIR / "bubblebot_crash_counter.txt"
