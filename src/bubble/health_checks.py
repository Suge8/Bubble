"""
health_checks.py
Health and crash-loop protection for Bubble macOS overlay app.
"""
...
def get_log_dir():
    ...
    log_dir = Path.home() / "Library" / "Logs" / "bubble"
...
LOG_DIR = get_log_dir()
LOG_PATH = LOG_DIR / "bubble_error_log.txt"
CRASH_COUNTER_FILE = LOG_DIR / "bubble_crash_counter.txt"
